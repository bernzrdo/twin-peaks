import './style.scss'
import bgImgUrl from './img/background.png'
...
const $transparent: HTMLInputElement = document.querySelector('#transparent')!
...
function render(){
    ...
    // background
    $img.classList.toggle('transparent', $transparent.checked)
